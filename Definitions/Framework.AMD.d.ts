...
export class ObservableCollection<T> {
    ...
    */
    ...
    /**
     * Removes the event subscriptions that were created when sync() was called.
     * This effectively unbinds the synchronization that exists between this ObservableCollection and another
...
export class Application {
    ...
    */
    ...
    private _traceEventListenerHandle;
    /** Indicates that log event should be stashed. */
    private _stashLog;
    /** Array of stashed logs (as published by the TraceEvent). */
    private _stashedLogs;
    /**
    ...
    /**
     * Return an array of stashed log.
     * This is meant to be called one, since after it is called, it will stop stashing logs.
     * This should be used by the log module.
     */
    getStashedLogs(): any[];
    ...
    */
    ...
    /**
     * Returns an array of library bundle uris that this library depends on.
     * @private
     */
    private getLibraryDependencyUris(config, configs);
    /**
    ...
    /**
     * Listens to the TaceEvent and stash any log until the Log module takes over
     * @private
     */
    private _traceEventListener(args);
    /**
...
export class LibraryConfig {
    ...
    location: string;
    /**
     * List of async library Ids that this async library depends on. There is no circular dependency detection or auto sorting packages, so
     * it is important to define the libraries in the config in the correct order and include all dependencies.
     */
    libraryDependencies: string[];
