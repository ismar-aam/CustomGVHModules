...
export function focusToDismissThis(view: ViewBase, onOtherFocused?: (evt?: Event) => void, shouldIgnoreFocus?: (evt?: Event) => boolean): void;
...
export function disableFocusToDismiss(view: ViewBase): void;
