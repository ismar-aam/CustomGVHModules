...
export class FeatureLayerService extends MapService {
    ...
    /**
     * Sets the opacity of the {@link FeatureLayerService}.
...
export class Map extends AsyncInitializable {
     ...
     * @param args The Geocortex map service, containing a service layer and Geocortex layers, to be integrated onto the map and into the viewer.
     * Can optionally accept an object containing "mapService" and "respectVisibility" properties. By default, visibilities of all added mapServices
     * and layers are set to true. However, if "respectVisibility" is set to true, then this function will respect whatever visibility the added
     * mapService is configured with. Supported map service types include: {@link essentials.FeatureLayerService}, {@link essentials.KmlService},
     * and {@link geocortex.essentialsHtmlViewer.mapping.infrastructure.LayerIntegrationUtils.LocalFeatureLayerService}.
     */
    addMapService(args: MapService | {
        mapService: MapService;
     ...
     * This can either be a spatial layer or a feature layer representing a table
...
export class MapService extends AsyncInitializable {
    ...
    clusterLayer: esri.layers.Layer;
    /** The Layer object for exploded clusters. */
    explodedClusterLayer: esri.layers.Layer;
    /** The security token that must be provided when requesting the service from ArcGIS Server. */
    serviceToken: string;
...
export class ServiceDiscoveryUtilities {
     ...
     * @param   respectConfiguredLayerVisibilities An optional boolean which, if set to true, will respect the configured visibilities for the
                created map service layers. The default value is false. All layer visibilities are set to true by default.
     * @returns The promise of a Geocortex map service.
     */
    static buildMapService(essentialsMap: Map, serviceDefinition: any, respectConfiguredLayerVisibilities?: boolean): Thenable<MapService>;
}
